...
require_once($CFG->dirroot . '/report/newplugin/classes/report_graphic.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class report_newplugin_renderable implements renderable {
    ...
    public function get_gcharts_data() {
        $graphreport = new report_newplugin($this->course->id);
    ...
    public function get_courses_activity() {
        $graphreport = new report_newplugin();
