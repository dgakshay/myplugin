...
require_once($CFG->dirroot . '/report/newplugin/lib/gcharts.php');
/**
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class report_newplugin extends Gcharts {
    ...
    public function get_most_triggered_events() {
        ...
        $events[0] = array(get_string('event', 'report_newplugin'), get_string('quantity', 'report_newplugin'));
        ...
        $this->load(array('newplugin_type' => 'ColumnChart'));
        $this->set_options(array('title' => get_string('eventsmosttriggered', 'report_newplugin')));
    ...
    public function get_most_active_users() {
        ...
        $useractivity[0] = array(get_string('user'), get_string('percentage', 'report_newplugin'));
        ...
        $this->load(array('newplugin_type' => 'PieChart'));
        $this->set_options(array('title' => get_string('usersactivity', 'report_newplugin')));
    ...
    public function get_monthly_user_activity() {
        ...
        $this->load(array('newplugin_type' => 'linechart'));
        $this->set_options(array('title' => get_string('eventsbymonth', 'report_newplugin', $year), 'curveType' => 'function'));
    ...
    public function get_courses_activity() {
        ...
        $i = 1;
        $courseactivity[0] = array(get_string('course'), get_string('percentage', 'report_newplugin'));
        ...
        $this->load(array('newplugin_type' => 'PieChart'));
        $this->set_options(array('title' => get_string('coursesactivity', 'report_newplugin')));
