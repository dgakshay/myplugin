...
$actionurl = new moodle_url('/report/newplugin/course.php');
$PAGE->set_context($context);
$PAGE->set_url('/report/newplugin/course.php', array('courseid' => $courseid));
$PAGE->set_title(get_string('pluginname', 'report_newplugin'));
$PAGE->set_heading(get_string('pluginname', 'report_newplugin'));
$PAGE->set_pagelayout('report');
echo $OUTPUT->header();
$renderable = new report_newplugin_renderable($course);
