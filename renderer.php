 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class report_newplugin_renderer extends plugin_renderer_base {

    /** @var report_newplugin_renderable instance of report graphic renderable. */
    protected $renderable;

    /**
     * Renderer constructor.
     *
     * @param report_newplugin_renderable $renderable newplugin report renderable instance.
     */
    protected function render_report_newplugin(report_newplugin_renderable $renderable) {
    ...
    public function report_selector_form() {
        ...
        echo html_writer::empty_tag('input', array('type' => 'submit', 'value' => get_string('generate', 'report_newplugin')));
